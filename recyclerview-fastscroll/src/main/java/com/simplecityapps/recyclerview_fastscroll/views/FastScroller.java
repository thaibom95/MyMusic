...
public class FastScroller {
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        mThumbHeight = Utils.toPixels(resources, 36);
        mWidth = Utils.toPixels(resources, 6);
        mWidthTrack = Utils.toPixels(resources, 2);
...
//            mTrack.setColor(trackColor);
    ...
    public void draw(Canvas canvas) {
        ...
        //Background
        canvas.drawRect(mThumbPosition.x + mOffset.x, mOffset.y, mThumbPosition.x + mOffset.x + mWidthTrack, mRecyclerView.getHeight() + mOffset.y, mTrack);

        //Handle
        canvas.drawRect(mThumbPosition.x + mOffset.x - (mWidth + mWidthTrack)/2, mThumbPosition.y + mOffset.y, mThumbPosition.x + mOffset.x + mWidth, mThumbPosition.y + mOffset.y + mThumbHeight, mThumb);
